...
async function handlePartyButtons(interaction) {
    ...
    if (customId.startsWith('help_page_')) {
        ...
        const newEmbed = createHelpEmbed(pageIndex, guildName);
        ...
        const row = new ActionRowBuilder().addComponents(
            ...
            new ButtonBuilder().setCustomId('help_page_1').setLabel('📊 Komutlar').setStyle(pageIndex === 1 ? ButtonStyle.Primary : ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId('help_page_2').setLabel('🛡️ Yönetim').setStyle(pageIndex === 2 ? ButtonStyle.Primary : ButtonStyle.Secondary),
            new ButtonBuilder().setCustomId('help_page_3').setLabel('🌐 Bağlantılar').setStyle(pageIndex === 3 ? ButtonStyle.Primary : ButtonStyle.Secondary)
        );
    ...
    if (customId.startsWith('members_')) {
        ...
        try {
            ...
            const newEmbed = createMemberPageEmbed(members, newPage, guildConfig.guild_name);
